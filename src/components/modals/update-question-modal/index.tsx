...
import { useUpdateQuestion } from "@/common/hooks/mutations";
...
const questionSchema = z.object({
  question_number: z.number().min(1, "Question number must be positive"),
  ...
  useEffect(() => {
    if (question && open) {
      reset({
        ...
        difficulty: question.difficulty || QuestionDifficultyType.Easy,
  ...
  const onSubmit: SubmitHandler<UpdateQuestionForm> = async (data) => {
    ...
    try {
      const formattedQuestion = {
        ...
        solution_steps:
          data.solution_steps?.filter((s) => s.trim() !== "") || [],
      };
      ...
      onUpdate(updatedQuestion.data?.updateQuestion);
      reset();
      onClose();
    } catch (error) {
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-gray-950">
            Update Question {question?.question_number}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="flex flex-col space-y-6 mt-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-900">
              Update the question details below. All fields marked with an
          ...
          <div className="flex gap-4">
            <div className="flex flex-col space-y-2 flex-1">
              ...
              <Select
                onValueChange={(value: QuestionType) => setValue("type", value)}
                value={watch("type")}
              >
                <SelectTrigger
                  className={cn(
            ...
            <div className="flex flex-col space-y-2 flex-1">
              ...
              <Select
                onValueChange={(value: QuestionDifficultyType) =>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <ul className="text-xs text-yellow-800 space-y-1">
              <li>
                • Updating this question will reflect changes across all related
                reviews
              </li>
              <li>• Make sure to review all fields carefully before saving</li>
              <li>
                • Empty hints and solution steps will be automatically removed
              </li>
            </ul>
          </div>
